            ...
            <div class="whole">
                <div class="form-outer">
                    <form onsubmit="return validateForm_update_doctor(event)"
                        action="/neocardio-hospital/update-details-doctor.php" name="update_doctor"
                        ...
                        <div class="form">
                            ...
                            <div class="formdesign" id="language">
                                ...
                                <div class="gender-part" value="<?php echo $row['languages'];?>">
                                    <label for="other">
                                        <input type="checkbox" name="languages[]" value="Other" <?php echo
                                            (isset($row['languages']) && in_array('Other', explode(',',
                                            $row['languages']))) ? 'checked' : '' ; ?>>Other
                                    </label>
                                    <label for="sinhala">
                                        <input type="checkbox" name="languages[]" value="Sinhala" <?php echo
                                            (isset($row['languages']) && in_array('Sinhala', explode(',',
                                            $row['languages']))) ? 'checked' : '' ; ?>>Sinhala
                                    </label>
                                    <label for="english">
